    ...
    <div className="p-4 sm:p-8 pb-32">
                    ...
                    >
                        ...
                        <div className="flex items-center cursor-pointer" onClick={() => onViewProfile(student)}>
                            <div className="flex-shrink-0 h-10 w-10 relative">
                                <img className="h-10 w-10 rounded-full object-cover border border-slate-200 dark:border-slate-600" src={student.avatar} alt={student.name} />
                                {student.orderNumber && (
        ...
        <div className="md:hidden grid grid-cols-1 sm:grid-cols-2 gap-4 select-none">
            ...
            {filteredStudents.map(student => {
                ...
                return (
                    <div 
                        key={student.id} 
                        className={`relative rounded-2xl shadow-sm p-4 transition-all duration-200 touch-manipulation ${
                            isSelected 
                    ...
                    >
                        ...
                        <div className="flex items-start gap-4 pointer-events-none">
                            <div className="relative flex-shrink-0">
                                <img className="h-14 w-14 rounded-full object-cover border-2 border-slate-100 dark:border-slate-700" src={student.avatar} alt={student.name} />
                                {student.orderNumber && (
      ...
      {!isSelectionMode && (
          <div className="fixed bottom-6 right-6 z-30 flex flex-col items-end pointer-events-none">
            <div 
            className={`flex flex-col items-end space-y-4 mb-4 transition-all duration-300 ease-in-out ${
                isFabOpen ? 'opacity-100 translate-y-0 pointer-events-auto' : 'opacity-0 translate-y-10 pointer-events-none'
            }`}
            >
