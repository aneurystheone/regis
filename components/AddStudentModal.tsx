...
const TabButton: React.FC<{
  ...
  <button
    type="button"
    onClick={onClick}
    className={`flex-1 flex flex-col sm:flex-row items-center justify-center gap-2 px-2 py-3 text-sm font-medium border-b-2 transition-colors focus:outline-none ${
      isActive
