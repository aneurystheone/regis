...
export const RecycleBin: React.FC<RecycleBinProps> = ({ deletedStudents, classes, onRestore, onPermanentDelete }) => {
        ...
        <table className="min-w-full divide-y divide-slate-200 dark:divide-slate-700">
          ...
          <tbody className="bg-white dark:bg-slate-800 divide-y divide-slate-200 dark:divide-slate-700">
            ...
            {deletedStudents.length === 0 && (
              <tr>
                <td colSpan={3} className="text-center py-10 text-slate-500 dark:text-slate-400">La papelera de reciclaje está vacía.</td>
              </tr>
            )}
          </tbody>
        </table>
