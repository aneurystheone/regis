...
import { SunIcon, MoonIcon, TableCellsIcon, CheckIcon, ExclamationIcon, SparklesIcon, DocumentTextIcon, ChartBarIcon, UserPlusIcon, MicrophoneIcon, ChatBubbleBottomCenterTextIcon } from './icons';
import type { FontSize, AIFeatures } from '../types';
import { uploadCurriculumData } from '../services/curriculumService';

interface SettingsManagerProps {
    activeSubView: 'APPEARANCE' | 'AI';
    isDarkMode: boolean;
...
export const SettingsManager: React.FC<SettingsManagerProps> = ({ isDarkMode, setIsDarkMode, fontSize, setFontSize, aiFeatures, setAiFeatures, activeSubView, currentUserEmail }) => {
