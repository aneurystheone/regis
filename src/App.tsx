...
function App() {
  ...
  const getHeaderTitle = () => {
    if (selectedStudent && currentView === 'STUDENT_PROFILE') return shortenName(selectedStudent.name);
    
    const titles: Record<View, string> = {
      DASHBOARD: 'Panel',
      LESSON_PLANNER: 'Planificación',
      CLASSES: 'Cursos',
